...
/* ======= 🔵 INSERT RECAPTCHA VERIFICATION BELOW THIS LINE 🔵 ======= */

$recaptchaSecret = $_ENV['RECAPTCHA_SECRET']; // Your secret key from .env
...
$verifyResponse = file_get_contents(
    "https://www.google.com/recaptcha/api/siteverify?secret={$recaptchaSecret}&response={$token}&remoteip={$ip}"
);
...
$rateLimitDuration = 20; // 60 seconds per submission
